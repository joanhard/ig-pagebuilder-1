    ...
    $.HandleSetting.shortcodePreview = function (params, shortcode, curr_iframe, callback)
    {
        ...
        if(params == null){
            ...
            // shortcode element
                ...
                if(window.parent.jQuery.noConflict()( '#jsn_view_modal').contents().find('#table_content').length > 0){
                    window.parent.jQuery.noConflict()( '#jsn_view_modal').contents().find('#ig_share_data').text(tinymce_content);
                }
