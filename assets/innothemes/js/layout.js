    ...
    JSNLayoutCustomizer.prototype = {
        ...
        addElement:function(){
            ...
            this.wrapper.delegate(this.addelements,"click",function(e){
                if($("#ig-add-element").is(':animated')) return;
                e.stopPropagation();
                $("#ig-add-element").hide();
                $("#ig-add-element").fadeIn(500);//removeClass('hidden');
                var filter_select = $("#ig-add-element").find("select.jsn-filter-button");
                ...
                var elmStylePopover = self.getBoxStyle($("#ig-add-element").find(".popover")),
                ...
                var row_idx= $("#form-container .jsn-row-container").index($(this).parents('.jsn-row-container'));
                var element_in_col= $(this).parent('.jsn-column-content').find('.jsn-element').length;
                offset_.top = (row_idx == 0 && element_in_col < 3) ? (offset_.top + 40) : offset_.top;
                $("#ig-add-element").offset(offset_).click(function (e) {
                    e.stopPropagation();
                });
                ...
                $(document).click(function(){
                    $("#ig-add-element").hide();//addClass('hidden');
                });
