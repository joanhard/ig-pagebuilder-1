...
/**
 * Custom script for Content List element
 */
(function($) {
    "use strict";

    $.IG_ContentListElement = $.IG_ContentListElement || {};

    $.IG_ContentListElement = function() {
        $('#param-item_filter').on('change', function(e) {
            $.IG_ContentListElement_select();
    ...
    $.IG_ContentListElement_select = function() {
    ...
    $.IG_ContentListMenuChange = function() {
    ...
    $(document).ready(function() {
        $.IG_ContentListElement();
        $.IG_ContentListMenuChange();
        ...
        $('#param-ig_cl_source').on('change', function() {
            ...
            if (option_val == 'nav_menu_item' || option_val == 'page') {
                $('#parent-param-ig_cl_limit').addClass('ig_hidden_depend');
                $('#parent-param-items_per_page').addClass('ig_hidden_depend');
                $('#parent-param-paging').addClass('ig_hidden_depend');
            }else{
                $('#parent-param-ig_cl_limit').removeClass('ig_hidden_depend');
