...
if ( ! class_exists( 'IG_Video' ) ) {
	...
	class IG_Video extends IG_Pb_Element {
		...
		function generate_local_file( $params ) {
			...
			if ( $params['video_alignment'] === 'right' ) {
				$player_elements .= 'video_container.parent().css("float", "right")';
				$container_class .= 'clearafter ';
			} else if ( $params['video_alignment'] === 'center' ) {
				$player_elements .= 'video_container.parent().css("margin", "0 auto")';
			} else if ( $params['video_alignment'] === 'left' ) {
				$player_elements .= 'video_container.parent().css("float", "left")';
				$container_class .= 'clearafter ';
			}
