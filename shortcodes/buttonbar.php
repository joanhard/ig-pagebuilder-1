...
if ( ! class_exists( 'IG_ButtonBar' ) ) {
	...
	class IG_ButtonBar extends IG_Pb_Parent {
			...
			$this->items = array(
				...
				'styling' => array(
					...
					array(
						...
						'tooltip' => __( 'Show Title Description', IGPBL )
					),
					array(
						...
						'std'     => 'yes',
						'options' => array( 'yes' => __( 'Yes', IGPBL ), 'no' => __( 'No', IGPBL ) ),
						'tooltip' => __( 'Show Icon Description', IGPBL )
					),
					array(
						...
						'std'     => 'no',
						'options' => array( 'yes' => __( 'Yes', IGPBL ), 'no' => __( 'No', IGPBL ) ),
						'tooltip' => __( 'Group Button Description', IGPBL )
					),
				)
			);
		}
