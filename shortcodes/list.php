...
if ( ! class_exists( 'IG_List' ) ) {
	...
	class IG_List extends IG_Pb_Parent {
			...
			$this->items = array(
				...
				'styling' => array(
					...
					array(
						...
						'tooltip'    => __( 'Icon Position Description', IGPBL ),
					...
					array(
						...
						'tooltip'         => __( 'Icon Background Description', IGPBL ),
					...
					array(
						...
						'tooltip'         => __( 'Icon Color Description', IGPBL ),
						'container_class' => 'combo-group',
						'dependency'      => array( 'show_icon', '=', 'yes' )
					),
					array(
					...
					array(
						...
						'has_depend' => '1',
						'tooltip'    => __( 'Heading Font Description', IGPBL ),
						'class'      => 'input-medium',
