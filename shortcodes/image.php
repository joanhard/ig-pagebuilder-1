...
if ( ! class_exists( 'IG_Image' ) ) {
	...
	class IG_Image extends IG_Pb_Element {
			...
			$this->items = array(
				'content' => array(
					...
					array(
						...
						'id'      => 'image_size',
						'type'    => 'large_image',
						'tooltip' => __( 'Image Size Description', IGPBL )
					),
					array(
						...
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => '',
						'tooltip' => __( 'Alt Text Description', IGPBL )
					),
					array(
					...
					array(
						...
						'id'         => 'image_image_size',
						'type'       => 'large_image',
						'tooltip'    => __( 'Large Image Size', IGPBL ),
				...
				'styling' => array(
					...
					array(
						...
						'tooltip' => 'Fade in Animations Description',
					),
				)
			);
		}
