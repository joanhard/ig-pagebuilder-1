...
if ( ! class_exists( 'IG_PromoBox' ) ) {
	...
	class IG_PromoBox extends IG_Pb_Element {
			...
			$this->items = array(
				'content' => array(
					...
					array(
						...
						'tooltip' => __( 'Promotion Title Description', IGPBL )
					),
					array(
						'id'      => 'pb_content',
						'role'    => 'content',
						...
						'tooltip' => __( 'Promotion Content Description', IGPBL )
					),
					array(
						...
						'class'   => 'jsn-input-xxlarge-fluid',
						'std'     => 'Button Title',
						'tooltip' => __( 'Button Title Description', IGPBL )
					),
					array(
						...
						'tooltip'    => __( 'Button Link Description', IGPBL ),
						'has_depend' => '1',
					),
					array(
						'name'       => __( 'URL', IGPBL ),
				...
				'styling' => array(
					...
					array(
						...
						'tooltip' => __( 'Background Description', IGPBL ),
					...
					array(
						...
						'tooltip'          => __( 'Border Description', IGPBL )
					),
					array(
						...
						'tooltip'         => __( 'Border Color Description', IGPBL ),
						'container_class' => 'combo-group',
					),
					array(
						...
						'tooltip' => __( 'Show Shadow Description', IGPBL )
					),
					array(
						...
						'tooltip'         => __( 'Elements Description', IGPBL ),
					...
					array(
						...
						'has_depend'        => '1',
						'class'             => 'input-medium',
						'tooltip'           => __( 'Font Description', IGPBL ),
					...
					array(
						...
						'tooltip'           => __( 'Bottom Padding Description', IGPBL ),
						'container_class'   => 'hidden',
						'data_wrap_related' => 'title',
					),
					array(
						...
						'tooltip'           => __( 'Bottom Margin Description', IGPBL ),
						'container_class'   => 'hidden',
						'data_wrap_related' => 'title',
					),
					array(
	...
	$(\'head\').append("<link rel=\'stylesheet\' href=\'http://fonts.googleapis.com/css?family=' . $title_font_face_value . '\' type=\'text/css\' media=\'all\' />");
});})(jQuery)</script>';
